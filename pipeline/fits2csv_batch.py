...
def get_list(input_dir):
    command=["find", input_dir, "-name", "*.fits*"]
...
def print_credit():
    print(" ===============================================")
    print(" = BELISAMA FITS TO CSV CONVERTOR (batch mode) =")
    print(" =      Version 1.0 by Yuuki Wada (RIKEN)      =")
    print(" =              19 August 2020                 =")
    print(" ===============================================")
...
if len(args)<2:
    ...
    print("Usage: python fits2csv.py <input directory> <output directory>")
    exit()
...
input_files=get_list(input_dir)
